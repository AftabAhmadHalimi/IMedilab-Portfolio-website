...
const Hero = () => {
  return (
    <>
    <div id='home'  className="hero h-screen bg-no-repeat bg-center bg-cover flex justify-center items-center max-lg:h-fit max-lg:py-10" style={{backgroundImage: `url(${HeroImg})`}}>
